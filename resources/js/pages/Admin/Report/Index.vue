                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="td-30">
                                            Total Product Terjual (Bulan ini):
                                        </td>
                                        <td class="td-70">
                                            {{ total.product_sold_thismo }}
                                        </td>
                                    </tr>
                                    <tr>
...
export default {
    mounted() {
        var $barData = [{ y: "2009-02-12", a: 100 }];
        this.getTotalReport();
        setTimeout(() => {
            this.showTransactionChart(
                "transaction-chart",
                this.total.transactionChart,
                "y",
                ["a"],
                ["Jumlah Penjualan: "],
                ["#5985ee"]
    ...
    methods: {
        getTotalReport() {
            axios.get("/api/v1/report").then(res => {
                ...
                this.total.product_sold_thismo =
                    res.data.total.product_sold_thismo;
            });
        },
